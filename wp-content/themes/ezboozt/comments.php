...
<div id="comments" class="comments-area">
    ...
    if (have_comments()) : ?>
        <h2 class="comments-title">
            ...
            if ('1' === $comments_number) {
                ...
                printf( _x( 'One Reply to &ldquo;%s&rdquo;', 'comments title', 'ezboozt' ), get_the_title() );
            } else {
                printf(
    ...
    if (!comments_open() && get_comments_number() && post_type_supports( get_post_type(), 'comments' )) : ?>
        ...
        <p class="no-comments"><?php _e( 'Comments are closed.', 'ezboozt' ); ?></p>
        <?php
    endif;
    comment_form();
    ?>
