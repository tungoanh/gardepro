 ...
 */
class OTF_Customize_Control_Color extends WP_Customize_Control {
    ...
    public function enqueue() {
        wp_enqueue_style(
            'alpha-color-picker',
            OPAL_THEME_FRAMEWORK_PLUGIN_URL . 'assets/3rd-party/alpha-color-picker/alpha-color-picker.css',
