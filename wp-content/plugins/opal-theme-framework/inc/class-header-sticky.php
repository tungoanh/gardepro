...
class OTF_Header_Sticky {
    ...
    private function checkEnableSticky() {
        return get_theme_mod('otf_header_layout_is_sticky', false) && (!get_theme_mod('otf_header_layout_enable_side_header', false));
    }
    ...
    public function render_template() {
        $layout = get_theme_mod('otf_header_layout_sticky_layout', '1');
