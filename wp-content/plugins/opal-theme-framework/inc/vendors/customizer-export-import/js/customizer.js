(function ($) {
    ...
    var CEI = {
        ...
        init: function () {
            ...
            $('input[name=cei-export-button-full]').on('click', CEI._export_full);
            $('input[name=cei-export-button-settings]').on('click', CEI._export_settings);
            $('input[name=cei-import-button]').on('click', CEI._import);
        },

        _export_full: function () {
            window.location.href = CEIConfig.customizerURL + '?cei-export-all=' + CEIConfig.exportNonce;
        },
        _export_settings: function () {
            window.location.href = CEIConfig.customizerURL + '?cei-export-settings=' + CEIConfig.exportNonce;
        },
        _export      : function () {
