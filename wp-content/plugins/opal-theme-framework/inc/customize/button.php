<?php
$cssCode = '';
$enable_custom = get_theme_mod('otf_colors_buttons_enable_custom', false);
if ($enable_custom) {
    $primary = get_theme_mod('otf_colors_buttons_primary_bg', '#222');
    $primary_border = get_theme_mod('otf_colors_buttons_primary_border', '#222');
    $primary_color = get_theme_mod('otf_colors_buttons_primary_color', '#fff');
    $primary_color_outline = get_theme_mod('otf_colors_buttons_primary_color_outline', '#222');
    $primary_hover = get_theme_mod('otf_colors_buttons_primary_hover_bg', '#222');
    $primary_border_hover = get_theme_mod('otf_colors_buttons_primary_hover_border', '#222');
    $primary_color_hover = get_theme_mod('otf_colors_buttons_primary_hover_color', '#fff');

    $secondary = get_theme_mod('otf_colors_buttons_secondary_bg', '#767676');
    $secondary_border = get_theme_mod('otf_colors_buttons_secondary_border', '#767676');
    $secondary_color = get_theme_mod('otf_colors_buttons_secondary_color', '#fff');
    $secondary_color_outline = get_theme_mod('otf_colors_buttons_secondary_color_outline', '#767676');
    $secondary_hover = get_theme_mod('otf_colors_buttons_secondary_hover_bg', '#767676');
    $secondary_border_hover = get_theme_mod('otf_colors_buttons_secondary_hover_border', '#767676');
    $secondary_color_hover = get_theme_mod('otf_colors_buttons_secondary_hover_color', '#fff');
} else {
    $ariPrimary = ariColor::new_color(get_theme_mod('otf_colors_general_primary', '#0160b4'));
    ...
    $ariSecondary = ariColor::new_color(get_theme_mod('otf_colors_general_secondary', '#00c484'));
...
$button_css = '';
$button_font = get_theme_mod('otf_typography_button_font_family');
...
$font_style = get_theme_mod('otf_typography_button_font_style');
$font_style_code = '';
...
$animation = get_theme_mod('otf_animations_buttons_background', 1);
$border_radius = get_theme_mod('otf_layout_buttons_border_radius', 3);

$cssCode .= apply_filters('otf_customize_button_primary_color', $cssCode, $primary, $primary_hover, $primary_border, $primary_border_hover, $primary_color, $primary_color_hover, $border_radius, $primary_color_outline, $button_css, $font_style_code);
$cssCode .= apply_filters('otf_customize_button_secondary_color', $cssCode, $secondary, $secondary_hover, $secondary_border, $secondary_border_hover, $secondary_color, $secondary_color_hover, $border_radius, $secondary_color_outline, $button_css, $font_style_code);
