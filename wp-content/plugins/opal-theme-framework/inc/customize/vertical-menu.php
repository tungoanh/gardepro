 ...
 */
$vertical_menu_font = get_theme_mod('otf_typography_vertical_menu_font_family');
...
$font_style = get_theme_mod('otf_typography_vertical_menu_font_style');
$font_style_code = '';
...
$font_size = get_theme_mod('otf_typography_vertical_menu_font_size', 14);
