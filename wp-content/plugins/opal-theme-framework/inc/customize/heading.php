...
$font_style = get_theme_mod( 'otf_typography_general_heading_font_style' );
 ...
 * @var $line_height
 */
//$line_height = get_theme_mod( 'otf_typography_general_heading_line_height', 30 );
 ...
 * @var $letter_spacing
 */
$letter_spacing = get_theme_mod( 'otf_typography_general_heading_letter_spacing', 0 );
if ($letter_spacing && $letter_spacing != 0){
    $heading_css .= "letter-spacing: {$letter_spacing}px;";
}
$cssCode .= apply_filters('otf_customize_typo_heading', $cssCode, $heading_css);
return $cssCode;